                    ...
                    <form method="POST" action="{{ isset($employee) ? route('employee.update', $employee->id) : route('employee.store') }}" enctype="multipart/form-data">
                        ...
                        <div>
                            <div class="flex items-center space-x-6 justify-center">
                                <div class="shrink-0">
                                <img id='preview_img' class="h-16 w-16 object-cover rounded-full" src="https://static.vecteezy.com/system/resources/previews/009/292/244/non_2x/default-avatar-icon-of-social-media-user-vector.jpg" alt="Current profile photo" />
                                </div>
                                <label class="block">
